...
const PostPreviewList = (props: any) => {
    ...
    const printList = (list: any) => {
        ...
        list.forEach((el: any) => {
            ...
            if (!monthArticleCnt[year + "-" + month])
                monthArticleCnt[year + "-" + month] = 1;
        ...
        <>
            <div className="flex align-middle justify-between border-b pt-1 px-2">
                <div>
                    <ToggleButton
                        label={"년/월"}
                        onClick={(e: any) => setIsFilterDate(!isFilterDate)}
                    />
                </div>
                <form>
                    <label
                    ...
                    <div className="relative mb-1">
                        ...
                        <input
                            ...
                            type="search"
                            id="search"
                            className="block w-full p-4 sm:p-4 sm:pl-8 pl-10 text-sm text-gray-900 border border-gray-300 rounded bg-gray-50"
                            placeholder="Search"
                            required
                        />
