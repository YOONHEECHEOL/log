    ...
    return (
        <header className='flex justify-between bg-slate-800 p-4'>
            ...
            <div className='text-center text-slate-300 text-base '>
                <Link href={'https://github.com/YOONHEECHEOL'} target='_blank'>
                    <svg className='inline' width={32} height={32} style={{fill: 'white'}} aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true">
